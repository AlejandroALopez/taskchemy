...
function TodayRoutineList(props: any) {
  ...
  return (
    <div className={"flex flex-col w-8/12 bg-black rounded-2xl p-4 m-8 lg:w-3/12 md:w-4/12 drop-shadow-md"}>
      <div className={"flex flex-row items-center justify-between"}>
        <p className={"text-xl text-white font-medium"}>Routines Today</p>
      </div>
